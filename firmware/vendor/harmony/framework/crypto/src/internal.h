...
#include "crypto/src/ssl.h"

#ifdef HAVE_CRL
#include "crypto/src/crl.h"
#endif
...
#endif
#ifndef NO_HC128
#include "crypto/src/hc128.h"
#endif
#ifndef NO_RABBIT
#include "crypto/src/rabbit.h"
#endif
#ifndef NO_ASN
...
#include "crypto/src/hmac.h"
    ...
    #include "crypto/src/callbacks.h"
    #include "crypto/src/signal.h"
#endif
...
enum {
    ...
    TLS_NTRU_RSA_WITH_AES_128_CBC_SHA  = 0xe7,  /* classes w/ official SHA-256 */
    ...
    TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8 = 0xc6,
    TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8 = 0xc7,
...
enum Misc {
    ...
    VERSION_SZ     =  2,       /* length of protocol version */
...
/* for sniffer */
WOLFSSL_LOCAL int DoFinished(CYASSL* ssl, const byte* input, word32* inOutIdx,
                            int sniff);
WOLFSSL_LOCAL int DoApplicationData(CYASSL* ssl, byte* input, word32* inOutIdx);
...
#ifdef HAVE_NETX
    WOLFSSL_LOCAL int NetX_Receive(CYASSL *ssl, char *buf, int sz, void *ctx);
    WOLFSSL_LOCAL int NetX_Send(CYASSL *ssl, char *buf, int sz, void *ctx);
#endif /* HAVE_NETX */
...
WOLFSSL_LOCAL word16 TLSX_GetRequestSize(CYASSL* ssl);
WOLFSSL_LOCAL word16 TLSX_WriteRequest(CYASSL* ssl, byte* output);
#endif

#ifndef NO_WOLFSSL_SERVER
WOLFSSL_LOCAL word16 TLSX_GetResponseSize(CYASSL* ssl);
WOLFSSL_LOCAL word16 TLSX_WriteResponse(CYASSL* ssl, byte* output);
#endif

WOLFSSL_LOCAL int    TLSX_Parse(CYASSL* ssl, byte* input, word16 length,
...
#ifndef NO_WOLFSSL_SERVER
WOLFSSL_LOCAL int TLSX_ValidateEllipticCurves(CYASSL* ssl, byte first,
                                                                   byte second);
#endif
...
WOLFSSL_LOCAL void InitCiphers(CYASSL* ssl);
WOLFSSL_LOCAL void FreeCiphers(CYASSL* ssl);
...
WOLFSSL_LOCAL
WOLFSSL_SESSION* GetSession(CYASSL*, byte*);
WOLFSSL_LOCAL
int          SetSession(CYASSL*, WOLFSSL_SESSION*);

typedef void (*hmacfp) (CYASSL*, byte*, const byte*, word32, int, int);

#ifndef NO_CLIENT_CACHE
    WOLFSSL_SESSION* GetSessionClient(CYASSL*, const byte*, int);
#endif
...
typedef struct Buffers {
    ...
    buffer          certChain;              /* WOLFSSL_CTX owns */
                 /* chain after self, in DER, with leading size for each cert */
...
typedef struct Options {
    ...
    byte            closeNotify;        /* we've received a close notify */
...
WOLFSSL_LOCAL
int  InitSSL(CYASSL*, WOLFSSL_CTX*);
WOLFSSL_LOCAL
void FreeSSL(CYASSL*);
WOLFSSL_API void SSL_ResourceFree(CYASSL*);   /* Micrium uses */
...
/* internal functions */
WOLFSSL_LOCAL int SendChangeCipher(CYASSL*);
WOLFSSL_LOCAL int SendData(CYASSL*, const void*, int);
WOLFSSL_LOCAL int SendCertificate(CYASSL*);
WOLFSSL_LOCAL int SendCertificateRequest(CYASSL*);
WOLFSSL_LOCAL int SendServerKeyExchange(CYASSL*);
WOLFSSL_LOCAL int SendBuffered(CYASSL*);
WOLFSSL_LOCAL int ReceiveData(CYASSL*, byte*, int, int);
WOLFSSL_LOCAL int SendFinished(CYASSL*);
WOLFSSL_LOCAL int SendAlert(CYASSL*, int, int);
WOLFSSL_LOCAL int ProcessReply(CYASSL*);

WOLFSSL_LOCAL int SetCipherSpecs(CYASSL*);
WOLFSSL_LOCAL int MakeMasterSecret(CYASSL*);

WOLFSSL_LOCAL int  AddSession(CYASSL*);
WOLFSSL_LOCAL int  DeriveKeys(CYASSL* ssl);
WOLFSSL_LOCAL int  StoreKeys(CYASSL* ssl, const byte* keyData);

WOLFSSL_LOCAL int IsTLS(const CYASSL* ssl);
WOLFSSL_LOCAL int IsAtLeastTLSv1_2(const CYASSL* ssl);

WOLFSSL_LOCAL void FreeHandshakeResources(CYASSL* ssl);
WOLFSSL_LOCAL void ShrinkInputBuffer(CYASSL* ssl, int forcedFree);
WOLFSSL_LOCAL void ShrinkOutputBuffer(CYASSL* ssl);
#ifndef NO_CERTS
    ...
    #endif
#endif
WOLFSSL_LOCAL void BuildTlsFinished(CYASSL* ssl, Hashes* hashes,
                                   const byte* sender);
WOLFSSL_LOCAL void FreeArrays(CYASSL* ssl, int keep);
WOLFSSL_LOCAL  int CheckAvailableSize(CYASSL *ssl, int size);
WOLFSSL_LOCAL  int GrowInputBuffer(CYASSL* ssl, int size, int usedLength);

#ifndef NO_TLS
    WOLFSSL_LOCAL int  MakeTlsMasterSecret(CYASSL*);
    WOLFSSL_LOCAL void TLS_hmac(CYASSL* ssl, byte* digest, const byte* in,
                               word32 sz, int content, int verify);
#endif

#ifndef NO_WOLFSSL_CLIENT
    WOLFSSL_LOCAL int SendClientHello(CYASSL*);
    WOLFSSL_LOCAL int SendClientKeyExchange(CYASSL*);
    WOLFSSL_LOCAL int SendCertificateVerify(CYASSL*);
#endif /* NO_WOLFSSL_CLIENT */

#ifndef NO_WOLFSSL_SERVER
    WOLFSSL_LOCAL int SendServerHello(CYASSL*);
    WOLFSSL_LOCAL int SendServerHelloDone(CYASSL*);
    #ifdef WOLFSSL_DTLS
        WOLFSSL_LOCAL int SendHelloVerifyRequest(CYASSL*);
    #endif
#endif /* NO_WOLFSSL_SERVER */

#ifdef WOLFSSL_DTLS
    WOLFSSL_LOCAL int  DtlsPoolInit(CYASSL*);
    WOLFSSL_LOCAL int  DtlsPoolSave(CYASSL*, const byte*, int);
    WOLFSSL_LOCAL int  DtlsPoolTimeout(CYASSL*);
    WOLFSSL_LOCAL int  DtlsPoolSend(CYASSL*);
    WOLFSSL_LOCAL void DtlsPoolReset(CYASSL*);
