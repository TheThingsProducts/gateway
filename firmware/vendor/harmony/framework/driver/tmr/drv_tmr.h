...
/* Function:
  ...
  Returns:
    ...
    argument to  DRV_TMR_Deinitialize, DRV_TMR_Tasks, DRV_TMR_Tasks_ISR and
    DRV_TMR_Status functions.
...
// *****************************************************************************
// *****************************************************************************
// Section: TMR Driver 16-bit mode functions. These functions should be used
// only when the Timer is configured in 16 bit mode. Using the generic API
// version above is preferred though. These 16 bit mode functions will be
// deprecated later.
// *****************************************************************************
// *****************************************************************************
...
// *****************************************************************************
// *****************************************************************************
// Section: TMR Driver 32-bit mode functions. These functions should be used
// only when the Timer is configured in 32 bit mode. Using the generic API
// version above is preferred though. These 32 bit mode functions will be
// deprecated later.
// *****************************************************************************
// *****************************************************************************
