...
<#if CONFIG_DRV_TMR_INTERRUPT_MODE == false>
void DRV_TMR_Tasks(SYS_MODULE_OBJ object)
{
<#if CONFIG_DRV_TMR_INST_0 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX0}))
    {
        DRV_TMR0_Tasks();
...
<#if CONFIG_DRV_TMR_INST_1 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX1}))
    {
        DRV_TMR1_Tasks();
...
<#if CONFIG_DRV_TMR_INST_2 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX2}))
    {
        DRV_TMR2_Tasks();
...
<#if CONFIG_DRV_TMR_INST_3 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX3}))
    {
        DRV_TMR3_Tasks();
...
<#if CONFIG_DRV_TMR_INST_4 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX4}))
    {
        DRV_TMR4_Tasks();
...
<#if CONFIG_DRV_TMR_INST_5 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX5}))
    {
        DRV_TMR5_Tasks();
...
<#if CONFIG_DRV_TMR_INST_6 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX6}))
    {
        DRV_TMR6_Tasks();
...
<#if CONFIG_DRV_TMR_INST_7 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX7}))
    {
        DRV_TMR7_Tasks();
...
<#if CONFIG_DRV_TMR_INST_8 == true>
    if (PLIB_INT_SourceFlagGet(INT_ID_0, ${CONFIG_DRV_TMR_INTERRUPT_SOURCE_IDX8}))
    {
        DRV_TMR8_Tasks();
