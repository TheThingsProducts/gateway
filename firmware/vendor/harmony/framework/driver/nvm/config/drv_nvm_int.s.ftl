...
<#if CONFIG_PIC32MX == true>
    <#assign NVM_ISR_VECTOR = CONFIG_INT_VECT_FCE>
<#else>
    <#assign NVM_ISR_VECTOR = CONFIG_INT_VECT_FLASH_CONTROL>
</#if>
/* NVM Interrupt */
<@RTOS_ISR VECTOR = NVM_ISR_VECTOR NAME = "DrvNvm" PRIORITY = CONFIG_DRV_NVM_INTERRUPT_PRIORITY/>
</#if>
<#--
/*******************************************************************************
 End of File
