<#--
/*******************************************************************************
  SD Card Driver Initialization File

  File Name:
    drv_sdcard_init.c.ftl

  Summary:
    This file contains source code necessary to initialize the SDCARD driver.
...
<#if CONFIG_USE_SYS_INT == true && CONFIG_DRV_NVM_INTERRUPT_MODE == true>    
    ...
    SYS_INT_VectorPrioritySet(${CONFIG_DRV_NVM_SYS_INTERRUPT_VECTOR}, ${CONFIG_DRV_NVM_INT_PRIO_NUM});
