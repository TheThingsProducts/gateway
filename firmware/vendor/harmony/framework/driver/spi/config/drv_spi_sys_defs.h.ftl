...
<#if CONFIG_DRV_SPI_IDX3 == true>
    ...
    /*** SPI Object for Index 3 ***/
    SYS_MODULE_OBJ				spiObjectIdx3;
</#if>
<#if CONFIG_DRV_SPI_IDX4 == true>
    
    /*** SPI Object for Index 4 ***/
    SYS_MODULE_OBJ				spiObjectIdx4;
</#if>
<#if CONFIG_DRV_SPI_IDX5 == true>
    
    /*** SPI Object for Index 5 ***/
    SYS_MODULE_OBJ				spiObjectIdx5;
</#if>