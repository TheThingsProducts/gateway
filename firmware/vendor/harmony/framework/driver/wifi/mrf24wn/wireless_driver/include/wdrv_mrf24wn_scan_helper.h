/*******************************************************************************
  MRF24WN Wi-Fi Driver Scan Helper Implementation

  File Name:
    wdrv_mrf24wn_scan_helper.h

  Summary:
    MRF24WN Wi-Fi Driver Scan Helper Implementation

  Description:
    -Provides access to MRF24WN WiFi controller
    -Reference: MRF24WN Datasheet, IEEE 802.11 Standard
 *******************************************************************************/
...
#ifndef _WDRV_MRF24WN_SCAN_HELPER_H
#define _WDRV_MRF24WN_SCAN_HELPER_H
...
#endif /* _WDRV_MRF24WN_SCAN_HELPER_H */
