...
#ifndef _WDRV_MRF24WN_IWPRIV_H
#define _WDRV_MRF24WN_IWPRIV_H
...
#if defined(WDRV_MRF24WN_IWPRIV_TASK)
...
/*
  ...
  Remarks:
    ...
    After the the module is connected, MRF24WN module can also do regular scans.
...
/*
  ...
  Remarks:
    ...
    WDRV_CSTATE_CONNECTION_PERMANENTLY_LOST is treated as a fail case and
...
#endif /* WDRV_MRF24WN_IWPRIV_TASK */
