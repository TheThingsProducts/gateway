...
#define TCPIP_DNSS_HOST_NAME_LEN		    		${CONFIG_TCPIP_DNSS_HOST_NAME_LEN}
...
#define TCPIP_DNSS_CACHE_PER_IPV4_ADDRESS			${CONFIG_TCPIP_DNSS_CACHE_PER_IPV4_ADDRESS}
#define TCPIP_DNSS_CACHE_PER_IPV6_ADDRESS			${CONFIG_TCPIP_DNSS_CACHE_PER_IPV6_ADDRESS}
#define TCPIP_DNSS_TTL_TIME							${CONFIG_TCPIP_DNSS_TTL_TIME}
#define TCPIP_DNSS_TASK_PROCESS_RATE			    ${CONFIG_TCPIP_DNSS_TASK_PROCESS_RATE}
