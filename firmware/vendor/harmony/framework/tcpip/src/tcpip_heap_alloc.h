...
extern __inline__ void* __attribute__((always_inline)) TCPIP_HEAP_Malloc(TCPIP_STACK_HEAP_HANDLE h, size_t nBytes)
{
    return (*((TCPIP_HEAP_OBJECT*)h)->TCPIP_HEAP_Malloc)(h, nBytes);
}

extern __inline__ void* __attribute__((always_inline)) TCPIP_HEAP_Calloc(TCPIP_STACK_HEAP_HANDLE h, size_t nElems, size_t elemSize)
{
    return (*((TCPIP_HEAP_OBJECT*)h)->TCPIP_HEAP_Calloc)(h, nElems, elemSize);
}

extern __inline__ size_t __attribute__((always_inline)) TCPIP_HEAP_Free(TCPIP_STACK_HEAP_HANDLE h, const void* ptr)
{
...
extern __inline__ TCPIP_STACK_HEAP_RES __attribute__((always_inline)) TCPIP_HEAP_Delete(TCPIP_STACK_HEAP_HANDLE h)
{
    return (*((TCPIP_HEAP_OBJECT*)h)->TCPIP_HEAP_Delete)(h);
}

extern __inline__ size_t __attribute__((always_inline)) TCPIP_HEAP_Size(TCPIP_STACK_HEAP_HANDLE h)
{
    return (*((TCPIP_HEAP_OBJECT*)h)->TCPIP_HEAP_Size)(h);
}

extern __inline__ size_t __attribute__((always_inline)) TCPIP_HEAP_MaxSize(TCPIP_STACK_HEAP_HANDLE h)
{
    return (*((TCPIP_HEAP_OBJECT*)h)->TCPIP_HEAP_MaxSize)(h);
}

extern __inline__ size_t __attribute__((always_inline)) TCPIP_HEAP_FreeSize(TCPIP_STACK_HEAP_HANDLE h)
{
    return (*((TCPIP_HEAP_OBJECT*)h)->TCPIP_HEAP_FreeSize)(h);
}

extern __inline__ TCPIP_STACK_HEAP_RES __attribute__((always_inline)) TCPIP_HEAP_LastError(TCPIP_STACK_HEAP_HANDLE h)
{
