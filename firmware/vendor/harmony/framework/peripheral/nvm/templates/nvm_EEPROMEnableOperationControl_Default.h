...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_EEPROM_WRITE_ENABLE_VREG(index)

  MASKs: 
    _NVM_EEPROM_WRITE_ENABLE_MASK(index)

  POSs: 
    _NVM_EEPROM_WRITE_ENABLE_POS(index)

  LENs: 
    _NVM_EEPROM_WRITE_ENABLE_LEN(index)
...
{
    _SFR_BIT_SET(_NVM_EEPROM_WRITE_ENABLE_VREG(index), _NVM_EEPROM_WRITE_ENABLE_POS(index));
}
...
{
    return (bool)(_SFR_BIT_READ(_NVM_EEPROM_WRITE_ENABLE_VREG(index), _NVM_EEPROM_WRITE_ENABLE_POS(index)));
}
...
{
    _SFR_BIT_CLEAR(_NVM_EEPROM_WRITE_ENABLE_VREG(index), _NVM_EEPROM_WRITE_ENABLE_POS(index));
}
