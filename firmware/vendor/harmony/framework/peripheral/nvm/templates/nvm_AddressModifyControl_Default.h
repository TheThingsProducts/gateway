...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_ADDRESS_MODIFY_CONTROL_VREG(index)

  MASKs: 
    _NVM_ADDRESS_MODIFY_CONTROL_MASK(index)

  POSs: 
    _NVM_ADDRESS_MODIFY_CONTROL_POS(index)

  LENs: 
    _NVM_ADDRESS_MODIFY_CONTROL_LEN(index)
...
{
    _SFR_WRITE( _NVM_ADDRESS_MODIFY_CONTROL_VREG( index ), address );
}
