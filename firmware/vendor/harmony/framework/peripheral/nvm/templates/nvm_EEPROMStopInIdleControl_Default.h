...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_EEPROM_STOP_IN_IDLE_VREG(index)

  MASKs: 
    _NVM_EEPROM_STOP_IN_IDLE_MASK(index)

  POSs: 
    _NVM_EEPROM_STOP_IN_IDLE_POS(index)

  LENs: 
    _NVM_EEPROM_STOP_IN_IDLE_LEN(index)
...
{
    _SFR_BIT_SET(_NVM_EEPROM_STOP_IN_IDLE_VREG(index), _NVM_EEPROM_STOP_IN_IDLE_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_NVM_EEPROM_STOP_IN_IDLE_VREG(index), _NVM_EEPROM_STOP_IN_IDLE_POS(index));
}
...
{
    return (bool)(_SFR_BIT_READ(_NVM_EEPROM_STOP_IN_IDLE_VREG(index), _NVM_EEPROM_STOP_IN_IDLE_POS(index)));
}
