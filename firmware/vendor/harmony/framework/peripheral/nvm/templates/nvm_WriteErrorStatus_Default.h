...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_WRITE_ERROR_STATUS_VREG(index)

  MASKs: 
    _NVM_WRITE_ERROR_STATUS_MASK(index)

  POSs: 
    _NVM_WRITE_ERROR_STATUS_POS(index)

  LENs: 
    _NVM_WRITE_ERROR_STATUS_LEN(index)
...
{
    return _SFR_BIT_READ(_NVM_WRITE_ERROR_STATUS_VREG(index), _NVM_WRITE_ERROR_STATUS_POS(index));
}
