...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_LOW_VOLTAGE_ERROR_VREG(index)

  MASKs: 
    _NVM_LOW_VOLTAGE_ERROR_MASK(index)

  POSs: 
    _NVM_LOW_VOLTAGE_ERROR_POS(index)

  LENs: 
    _NVM_LOW_VOLTAGE_ERROR_LEN(index)
...
{
    return (_SFR_BIT_READ(_NVM_LOW_VOLTAGE_ERROR_VREG(index),
                        _NVM_LOW_VOLTAGE_ERROR_POS(index)));
}
