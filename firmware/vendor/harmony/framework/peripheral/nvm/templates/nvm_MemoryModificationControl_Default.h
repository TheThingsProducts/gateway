...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_MEMORY_MODIFY_CONTROL_VREG(index)

  MASKs: 
    _NVM_MEMORY_MODIFY_CONTROL_MASK(index)

  POSs: 
    _NVM_MEMORY_MODIFY_CONTROL_POS(index)

  LENs: 
    _NVM_MEMORY_MODIFY_CONTROL_LEN(index)
...
{
    _SFR_BIT_SET(_NVM_MEMORY_MODIFY_CONTROL_VREG(index), _NVM_MEMORY_MODIFY_CONTROL_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_NVM_MEMORY_MODIFY_CONTROL_VREG(index), _NVM_MEMORY_MODIFY_CONTROL_POS(index));
}
