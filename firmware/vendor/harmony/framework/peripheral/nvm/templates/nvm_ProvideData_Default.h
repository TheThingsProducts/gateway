...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _NVM_PROVIDE_DATA_VREG(index)

  MASKs: 
    _NVM_PROVIDE_DATA_MASK(index)

  POSs: 
    _NVM_PROVIDE_DATA_POS(index)

  LENs: 
    _NVM_PROVIDE_DATA_LEN(index)
...
{
    _SFR_WRITE(_NVM_PROVIDE_DATA_VREG(index), data);
}
