...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_TRANSMITTER_BUFFER_FULL_VREG(index)

  MASKs: 
    _USART_TRANSMITTER_BUFFER_FULL_MASK(index)

  POSs: 
    _USART_TRANSMITTER_BUFFER_FULL_POS(index)

  LENs: 
    _USART_TRANSMITTER_BUFFER_FULL_LEN(index)
...
{
    return _SFR_BIT_READ(_USART_TRANSMITTER_BUFFER_FULL_VREG(index),
                             _USART_TRANSMITTER_BUFFER_FULL_POS(index) );
}
