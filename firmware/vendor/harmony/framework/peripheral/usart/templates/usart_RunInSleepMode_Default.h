...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_RUN_IN_SLEEP_VREG(index)

  MASKs: 
    _USART_RUN_IN_SLEEP_MASK(index)

  POSs: 
    _USART_RUN_IN_SLEEP_POS(index)

  LENs: 
    _USART_RUN_IN_SLEEP_LEN(index)
...
{
    _SFR_BIT_SET(_USART_RUN_IN_SLEEP_VREG(index),
         _USART_RUN_IN_SLEEP_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_USART_RUN_IN_SLEEP_VREG(index),
         _USART_RUN_IN_SLEEP_POS(index) );
}
...
{
    return _SFR_BIT_READ(_USART_RUN_IN_SLEEP_VREG(index),
        _USART_RUN_IN_SLEEP_POS(index));
}
