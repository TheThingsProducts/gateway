...
#define PLIB_USART_ExistsReceiver PLIB_USART_ExistsReceiver
...
//******************************************************************************
/* Function :  USART_ReceiverAddressGet_Default

  Summary:
    Implements Default variant of PLIB_USART_ReceiverAddressGet

  Description:
    This template implements the Default variant of the PLIB_USART_ReceiverAddressGet function.
*/

PLIB_TEMPLATE void* USART_ReceiverAddressGet_Default( USART_MODULE_ID index )
{
	return (uint32_t*)_USART_RECEIVER_DATA_VREG(index);
}
