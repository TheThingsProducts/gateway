...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_BAUD_RATE_AUTO_DETECT_VREG(index)

  MASKs: 
    _USART_BAUD_RATE_AUTO_DETECT_MASK(index)

  POSs: 
    _USART_BAUD_RATE_AUTO_DETECT_POS(index)

  LENs: 
    _USART_BAUD_RATE_AUTO_DETECT_LEN(index)
...
{
    _SFR_BIT_SET(_USART_BAUD_RATE_AUTO_DETECT_VREG(index),
	             _USART_BAUD_RATE_AUTO_DETECT_POS(index));
}
...
{
    return _SFR_BIT_READ(_USART_BAUD_RATE_AUTO_DETECT_VREG(index),
	                     _USART_BAUD_RATE_AUTO_DETECT_POS(index));
}
