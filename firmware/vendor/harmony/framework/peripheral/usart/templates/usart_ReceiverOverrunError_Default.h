...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_RECEIVER_OVERRUN_ERROR_VREG(index)

  MASKs: 
    _USART_RECEIVER_OVERRUN_ERROR_MASK(index)

  POSs: 
    _USART_RECEIVER_OVERRUN_ERROR_POS(index)

  LENs: 
    _USART_RECEIVER_OVERRUN_ERROR_LEN(index)
...
{
    _SFR_BIT_CLEAR(_USART_RECEIVER_OVERRUN_ERROR_VREG(index),
                       _USART_RECEIVER_OVERRUN_ERROR_POS(index) );
}
...
{
    return _SFR_BIT_READ(_USART_RECEIVER_OVERRUN_ERROR_VREG(index),
                             _USART_RECEIVER_OVERRUN_ERROR_POS(index) );
}
