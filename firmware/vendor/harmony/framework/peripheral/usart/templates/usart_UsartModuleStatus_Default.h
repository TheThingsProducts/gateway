...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_UART_STATUS_VREG(index)

  MASKs: 
    _USART_UART_STATUS_MASK(index)

  POSs: 
    _USART_UART_STATUS_POS(index)

  LENs: 
    _USART_UART_STATUS_LEN(index)
...
{
    return _SFR_BIT_READ(_USART_UART_STATUS_VREG(index),
        _USART_UART_STATUS_POS(index));
}
