...
#define PLIB_USART_ExistsTransmitter PLIB_USART_ExistsTransmitter
...
//******************************************************************************
/* Function :  USART_TransmitterAddressGet_Default

  Summary:
    Implements Default variant of PLIB_USART_TransmitterAddressGet

  Description:
    This template implements the Default variant of the PLIB_USART_TransmitterAddressGet function.
*/

PLIB_TEMPLATE void* USART_TransmitterAddressGet_Default( USART_MODULE_ID index )
{
	return (uint32_t*)_USART_TRANSMITTER_SEND_VREG(index);
}
