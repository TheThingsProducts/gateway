...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _USART_RECEIVER_ADDRESS_DETECT_VREG(index)

  MASKs:
    _USART_RECEIVER_ADDRESS_DETECT_MASK(index)

  POSs:
    _USART_RECEIVER_ADDRESS_DETECT_POS(index)

  LENs:
    _USART_RECEIVER_ADDRESS_DETECT_LEN(index)
...
{
    _SFR_BIT_SET(_USART_RECEIVER_ADDRESS_DETECT_VREG(index),
        _USART_RECEIVER_ADDRESS_DETECT_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_USART_RECEIVER_ADDRESS_DETECT_VREG(index),
        _USART_RECEIVER_ADDRESS_DETECT_POS(index) );
}
...
{
return _SFR_BIT_READ(_USART_RECEIVER_ADDRESS_DETECT_VREG(index),
        _USART_RECEIVER_ADDRESS_DETECT_POS(index) );
}
