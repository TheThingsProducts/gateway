...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_TRANSMITTER_BREAK_SEND_VREG(index)

  MASKs: 
    _USART_TRANSMITTER_BREAK_SEND_MASK(index)

  POSs: 
    _USART_TRANSMITTER_BREAK_SEND_POS(index)

  LENs: 
    _USART_TRANSMITTER_BREAK_SEND_LEN(index)
...
{
    _SFR_BIT_SET(_USART_TRANSMITTER_BREAK_SEND_VREG(index),
                     _USART_TRANSMITTER_BREAK_SEND_POS(index) );
}
...
{
    return _SFR_BIT_READ(_USART_TRANSMITTER_BREAK_SEND_VREG(index),
                     _USART_TRANSMITTER_BREAK_SEND_POS(index) );
}
