...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_RECEIVER_ENABLE_VREG(index)

  MASKs: 
    _USART_RECEIVER_ENABLE_MASK(index)

  POSs: 
    _USART_RECEIVER_ENABLE_POS(index)

  LENs: 
    _USART_RECEIVER_ENABLE_LEN(index)
...
{
    _SFR_BIT_SET(_USART_RECEIVER_ENABLE_VREG(index),
                     _USART_RECEIVER_ENABLE_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_USART_RECEIVER_ENABLE_VREG(index),
                     _USART_RECEIVER_ENABLE_POS(index) );
}
