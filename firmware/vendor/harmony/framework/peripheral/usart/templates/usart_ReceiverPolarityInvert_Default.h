...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _USART_RECEIVER_POLARITY_INVERT_VREG(index)

  MASKs: 
    _USART_RECEIVER_POLARITY_INVERT_MASK(index)

  POSs: 
    _USART_RECEIVER_POLARITY_INVERT_POS(index)

  LENs: 
    _USART_RECEIVER_POLARITY_INVERT_LEN(index)
...
{
    _SFR_BIT_CLEAR(_USART_RECEIVER_POLARITY_INVERT_VREG(index),
                     _USART_RECEIVER_POLARITY_INVERT_POS(index) );
}
...
{
_SFR_BIT_SET(_USART_RECEIVER_POLARITY_INVERT_VREG(index),
                     _USART_RECEIVER_POLARITY_INVERT_POS(index) );
}
