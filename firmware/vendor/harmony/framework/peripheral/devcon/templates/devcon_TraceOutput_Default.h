...
{
    _SFR_BIT_WRITE(_DEVCON_TRACE_OUTPUT_ENABLE_VREG(index),_DEVCON_TRACE_OUTPUT_ENABLE_POS(index),1);
}
...
{
    _SFR_BIT_WRITE(_DEVCON_TRACE_OUTPUT_ENABLE_VREG(index),_DEVCON_TRACE_OUTPUT_ENABLE_POS(index),0);
}
