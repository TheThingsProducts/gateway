...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _DEVCON_USB_SUSPEND_SLEEP_ENABLE_VREG(index)

  MASKs:
    _DEVCON_USB_SUSPEND_SLEEP_ENABLE_MASK(index)

  POSs:
    _DEVCON_USB_SUSPEND_SLEEP_ENABLE_POS(index)

  LENs:
    _DEVCON_USB_SUSPEND_SLEEP_ENABLE_LEN(index)
...
{
    _SFR_BIT_WRITE(_DEVCON_USB_SUSPEND_SLEEP_ENABLE_VREG(index),
                   _DEVCON_USB_SUSPEND_SLEEP_ENABLE_POS(index) ,
                   sleepOrRun                                  );
}
