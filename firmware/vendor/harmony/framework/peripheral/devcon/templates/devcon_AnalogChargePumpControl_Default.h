...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _DEVCON_ANALOG_CHARGE_PUMP_ENABLE_VREG(index)

  MASKs:
    _DEVCON_ANALOG_CHARGE_PUMP_ENABLE_MASK(index)

  POSs:
    _DEVCON_ANALOG_CHARGE_PUMP_ENABLE_POS(index)

  LENs:
    _DEVCON_ANALOG_CHARGE_PUMP_ENABLE_LEN(index)
...
{
    *((SFR_TYPE *)(_DEVCON_ANALOG_CHARGE_PUMP_ENABLE_VREG(index))) |=  1<<(_DEVCON_ANALOG_CHARGE_PUMP_ENABLE_POS(index) );
}
