...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _WDT_POSTSCALER_VALUE_VREG(index)

  MASKs: 
    _WDT_POSTSCALER_VALUE_MASK(index)

  POSs: 
    _WDT_POSTSCALER_VALUE_POS(index)

  LENs: 
    _WDT_POSTSCALER_VALUE_LEN(index)
...
{
    return (char)(_SFR_FIELD_READ(_WDT_POSTSCALER_VALUE_VREG(index),
                                _WDT_POSTSCALER_VALUE_MASK(index),
                                _WDT_POSTSCALER_VALUE_POS(index)));
}
