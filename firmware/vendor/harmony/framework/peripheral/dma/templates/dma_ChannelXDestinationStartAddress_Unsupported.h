...
PLIB_TEMPLATE uint32_t DMA_ChannelXDestinationStartAddressGet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel )
{
...
PLIB_TEMPLATE void DMA_ChannelXDestinationStartAddressSet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , uint32_t destinationStartAddress )
{
