...
PLIB_TEMPLATE bool DMA_ChannelXINTSourceFlagGet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , DMA_INT_TYPE dmaINTSource )
{
...
PLIB_TEMPLATE void DMA_ChannelXINTSourceFlagSet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , DMA_INT_TYPE dmaINTSource )
{
...
PLIB_TEMPLATE void DMA_ChannelXINTSourceFlagClear_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , DMA_INT_TYPE dmaINTSource )
{
