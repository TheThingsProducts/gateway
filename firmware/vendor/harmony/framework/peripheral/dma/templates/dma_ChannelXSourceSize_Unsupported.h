...
PLIB_TEMPLATE uint16_t DMA_ChannelXSourceSizeGet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel )
{
...
PLIB_TEMPLATE void DMA_ChannelXSourceSizeSet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , uint16_t sourceSize )
{
