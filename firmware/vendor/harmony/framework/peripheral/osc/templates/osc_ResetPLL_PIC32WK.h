...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_OSC_SYSTEM_PLL_RESET_VREG(index)
    _OSC_OSC_USB_PLL_RESET_VREG(index)
    _OSC_OSC_BT_PLL_RESET_VREG(index)

  MASKs: 
    _OSC_OSC_SYSTEM_PLL_RESET_MASK(index)
    _OSC_OSC_USB_PLL_RESET_MASK(index)
    _OSC_OSC_BT_PLL_RESET_MASK(index)

  POSs: 
    _OSC_OSC_SYSTEM_PLL_RESET_POS(index)
    _OSC_OSC_USB_PLL_RESET_POS(index)
    _OSC_OSC_BT_PLL_RESET_POS(index)

  LENs: 
    _OSC_OSC_SYSTEM_PLL_RESET_LEN(index)
    _OSC_OSC_USB_PLL_RESET_LEN(index)
    _OSC_OSC_BT_PLL_RESET_LEN(index)
...
PLIB_TEMPLATE void OSC_ResetPLLAssert_PIC32WK( OSC_MODULE_ID index , OSC_PLL_SELECT pllSel )
{
	...
	{
		case OSC_PLL_SYSTEM:
			_SFR_BIT_SET(_OSC_OSC_SYSTEM_PLL_RESET_VREG(index),
                       _OSC_OSC_SYSTEM_PLL_RESET_POS(index));
			break;
			
		case OSC_PLL_USB:
			_SFR_BIT_SET(_OSC_OSC_USB_PLL_RESET_VREG(index),
                       _OSC_OSC_USB_PLL_RESET_POS(index));
			break;
			
		case OSC_PLL_BT:
			_SFR_BIT_SET(_OSC_OSC_BT_PLL_RESET_VREG(index),
                       _OSC_OSC_BT_PLL_RESET_POS(index));
			break;
...
PLIB_TEMPLATE void OSC_ResetPLLDeassert_PIC32WK( OSC_MODULE_ID index , OSC_PLL_SELECT pllSel )
{
	...
	{
		case OSC_PLL_SYSTEM:
			_SFR_BIT_CLEAR(_OSC_OSC_SYSTEM_PLL_RESET_VREG(index),
                       _OSC_OSC_SYSTEM_PLL_RESET_POS(index));
			break;
			
		case OSC_PLL_USB:
			_SFR_BIT_CLEAR(_OSC_OSC_USB_PLL_RESET_VREG(index),
                       _OSC_OSC_USB_PLL_RESET_POS(index));
			break;
			
		case OSC_PLL_BT:
			_SFR_BIT_CLEAR(_OSC_OSC_BT_PLL_RESET_VREG(index),
                       _OSC_OSC_BT_PLL_RESET_POS(index));
			break;
...
PLIB_TEMPLATE bool OSC_ResetPLLStatus_PIC32WK( OSC_MODULE_ID index , OSC_PLL_SELECT pllSel )
{
	...
	{
		case OSC_PLL_SYSTEM:
			return _SFR_BIT_READ(_OSC_OSC_SYSTEM_PLL_RESET_VREG(index),
                       _OSC_OSC_SYSTEM_PLL_RESET_POS(index));
			
		case OSC_PLL_USB:
			return _SFR_BIT_READ(_OSC_OSC_USB_PLL_RESET_VREG(index),
                       _OSC_OSC_USB_PLL_RESET_POS(index));
			
		case OSC_PLL_BT:
			return _SFR_BIT_READ(_OSC_OSC_BT_PLL_RESET_VREG(index),
                       _OSC_OSC_BT_PLL_RESET_POS(index));
