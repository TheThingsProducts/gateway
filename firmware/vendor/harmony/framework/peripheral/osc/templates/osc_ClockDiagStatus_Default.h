...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_POSC_STOP_VREG(index)

  MASKs: 
    _OSC_POSC_STOP_MASK(index)

  POSs: 
    _OSC_POSC_STOP_POS(index)

  LENs: 
    _OSC_POSC_STOP_LEN(index)
...
{
	_SFR_BIT_SET(_OSC_POSC_STOP_VREG(index),
		   _OSC_POSC_STOP_POS(index) + clk);
}
...
{
	_SFR_BIT_CLEAR(_OSC_POSC_STOP_VREG(index),
		   _OSC_POSC_STOP_POS(index) + clk);
}
...
{
	return _SFR_BIT_READ(_OSC_POSC_STOP_VREG(index),
		   _OSC_POSC_STOP_POS(index) + clk);
}
