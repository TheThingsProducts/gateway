...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_DREAM_MODE_ENABLE_WK_VREG(index)

  MASKs: 
    _OSC_DREAM_MODE_ENABLE_WK_MASK(index)

  POSs: 
    _OSC_DREAM_MODE_ENABLE_WK_POS(index)

  LENs: 
    _OSC_DREAM_MODE_ENABLE_WK_LEN(index)
...
{
    _SFR_BIT_SET(_OSC_DREAM_MODE_ENABLE_WK_VREG(index),
                       _OSC_DREAM_MODE_ENABLE_WK_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_OSC_DREAM_MODE_ENABLE_WK_VREG(index),
                       _OSC_DREAM_MODE_ENABLE_WK_POS(index));
}
...
{
    return _SFR_BIT_READ(_OSC_DREAM_MODE_ENABLE_WK_VREG(index),
                       _OSC_DREAM_MODE_ENABLE_WK_POS(index));
}
