/*******************************************************************************
  ...
  File Name:
    osc_ReferenceOscDivisor_PIC32_3.h
...
#ifndef _OSC_REFERENCEOSCDIVISOR_PIC32_3_H
#define _OSC_REFERENCEOSCDIVISOR_PIC32_3_H
...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    ...
    _OSC_REF_CLK_OUTPUT_DIV_5_VREG(index)
  ...
  MASKs: 
    ...
    _OSC_REF_CLK_OUTPUT_DIV_5_MASK(index)
  ...
  POSs: 
    ...
    _OSC_REF_CLK_OUTPUT_DIV_5_POS(index)
  ...
  LENs: 
    ...
    _OSC_REF_CLK_OUTPUT_DIV_5_LEN(index)

*/


//******************************************************************************
/* Function :  OSC_ExistsReferenceOscDivisor_PIC32_3

  Summary:
    Implements PIC32_3 variant of PLIB_OSC_ExistsReferenceOscDivisor

  Description:
    This template implements the PIC32_3 variant of the PLIB_OSC_ExistsReferenceOscDivisor function.
*/

#define PLIB_OSC_ExistsReferenceOscDivisor PLIB_OSC_ExistsReferenceOscDivisor
PLIB_TEMPLATE bool OSC_ExistsReferenceOscDivisor_PIC32_3( OSC_MODULE_ID index )
{
    return true;
}
...
//******************************************************************************
/* Function :  OSC_ReferenceOscDivisorValueSet_PIC32_3

  Summary:
    Implements PIC32_3 variant of PLIB_OSC_ReferenceOscDivisorValueSet 

  Description:
    This template implements the PIC32_3 variant of the PLIB_OSC_ReferenceOscDivisorValueSet function.
*/

PLIB_TEMPLATE void OSC_ReferenceOscDivisorValueSet_PIC32_3( OSC_MODULE_ID index , OSC_REFERENCE referenceOsc , OSC_REF_DIVISOR_TYPE refOscDivValue )
{

    	_SFR_FIELD_WRITE(_OSC_REF_CLK_OUTPUT_DIV_1_VREG(index)+(referenceOsc * 0x08),
						 _OSC_REF_CLK_OUTPUT_DIV_1_MASK(index),
						 _OSC_REF_CLK_OUTPUT_DIV_1_POS(index) ,
						 refOscDivValue );
...
#endif /*_OSC_REFERENCEOSCDIVISOR_PIC32_3_H*/
