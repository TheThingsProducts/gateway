...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_OSC_BT_CLK_OUTPUT_VREG(index)

  MASKs: 
    _OSC_OSC_BT_CLK_OUTPUT_MASK(index)

  POSs: 
    _OSC_OSC_BT_CLK_OUTPUT_POS(index)

  LENs: 
    _OSC_OSC_BT_CLK_OUTPUT_LEN(index)
...
{
	_SFR_BIT_SET(_OSC_OSC_BT_CLK_OUTPUT_VREG(index),
			   _OSC_OSC_BT_CLK_OUTPUT_POS(index));
}
...
{
	_SFR_BIT_CLEAR(_OSC_OSC_BT_CLK_OUTPUT_VREG(index),
			   _OSC_OSC_BT_CLK_OUTPUT_POS(index));
}
...
{
	return _SFR_BIT_READ(_OSC_OSC_BT_CLK_OUTPUT_VREG(index),
			   _OSC_OSC_BT_CLK_OUTPUT_POS(index));
}
