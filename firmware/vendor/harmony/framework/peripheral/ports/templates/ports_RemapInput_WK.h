...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PORTS_REMAP_FUNC_INT0_VREG(index)

  MASKs: 
    _PORTS_REMAP_FUNC_INT0_MASK(index)

  POSs: 
    _PORTS_REMAP_FUNC_INT0_POS(index)

  LENs: 
    _PORTS_REMAP_FUNC_INT0_LEN(index)
...
{
    _SFR_FIELD_WRITE( _PORTS_REMAP_FUNC_INT0_VREG(index) + inputFunction,
                          _PORTS_REMAP_FUNC_INT0_MASK(index),
                          _PORTS_REMAP_FUNC_INT0_POS(index),
                            remapInputPin );
}
