...
{
    _SFR_BIT_SET( _PORTS_OPEN_DRAIN_B_VREG(index) + ((channel-1) * 0x40), bitPos );
}
...
{
     _SFR_BIT_CLEAR( _PORTS_OPEN_DRAIN_B_VREG(index) + ((channel-1) * 0x40), bitPos );
}
...
{
    _SFR_SET( _PORTS_OPEN_DRAIN_B_VREG(index) + ((channel-1) * 0x40), mask );
}
...
{
    _SFR_CLEAR( _PORTS_OPEN_DRAIN_B_VREG(index) + ((channel-1) * 0x40), mask );
}
