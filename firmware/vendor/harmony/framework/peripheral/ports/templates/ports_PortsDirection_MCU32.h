...
{
    _SFR_BIT_SET( _PORTS_DIRECTION_B_VREG(index) + ((channel-1) * 0x10), bitPos );
}
...
{
    _SFR_BIT_CLEAR( _PORTS_DIRECTION_B_VREG(index) + ((channel-1) * 0x10), bitPos );
}
...
{
    _SFR_SET( _PORTS_DIRECTION_B_VREG(index) + ((channel-1) * 0x10), mask );
}
...
{
    _SFR_CLEAR( _PORTS_DIRECTION_B_VREG(index) + ((channel-1) * 0x10), mask );
}
...
{
    return( _SFR_READ( _PORTS_DIRECTION_B_VREG(index) + ((channel-1) * 0x10) ) );
}
