...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PORTS_CHANGE_NOTICE_PULL_UP_VREG(index)

  MASKs: 
    _PORTS_CHANGE_NOTICE_PULL_UP_MASK(index)

  POSs: 
    _PORTS_CHANGE_NOTICE_PULL_UP_POS(index)

  LENs: 
    _PORTS_CHANGE_NOTICE_PULL_UP_LEN(index)
...
{
    _SFR_BIT_SET(_PORTS_CHANGE_NOTICE_PULL_UP_VREG(index),
                     pinNum );
}
...
{
    _SFR_BIT_CLEAR(_PORTS_CHANGE_NOTICE_PULL_UP_VREG(index),
                     pinNum );
}
...
{
    _SFR_SET(_PORTS_CHANGE_NOTICE_PULL_UP_VREG(index), cnPins );
}
...
{
    _SFR_CLEAR(_PORTS_CHANGE_NOTICE_PULL_UP_VREG(index), cnPins );
}
