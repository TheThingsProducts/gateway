/*******************************************************************************
  ...
  File Name:
    reset_ResetReasonStatus_MZ_1.h
...
#ifndef _RESET_RESETREASONSTATUS_MZ_1_H
#define _RESET_RESETREASONSTATUS_MZ_1_H
...
//******************************************************************************
/* Function :  RESET_ExistsResetReasonStatus_MZ_1

  Summary:
    Implements MZ_1 variant of PLIB_RESET_ExistsResetReasonStatus

  Description:
    This template implements the MZ_1 variant of the PLIB_RESET_ExistsResetReasonStatus function.
*/

#define PLIB_RESET_ExistsResetReasonStatus PLIB_RESET_ExistsResetReasonStatus
PLIB_TEMPLATE bool RESET_ExistsResetReasonStatus_MZ_1( RESET_MODULE_ID index )
{
    return true;
}
...
//******************************************************************************
/* Function :  RESET_ReasonGet_MZ_1

  Summary:
    Implements MZ_1 variant of PLIB_RESET_ReasonGet 

  Description:
    This template implements the MZ_1 variant of the PLIB_RESET_ReasonGet function.
*/

PLIB_TEMPLATE RESET_REASON RESET_ReasonGet_MZ_1( RESET_MODULE_ID index )
{
...
//******************************************************************************
/* Function :  RESET_ReasonClear_MZ_1

  Summary:
    Implements MZ_1 variant of PLIB_RESET_ReasonClear 

  Description:
    This template implements the MZ_1 variant of the PLIB_RESET_ReasonClear function.
*/

PLIB_TEMPLATE void RESET_ReasonClear_MZ_1( RESET_MODULE_ID index , RESET_REASON reason )
{
   _SFR_READ(_RESET_RESET_REASON_STATUS_EXTR_VREG(index)) = (~reason) & (_SFR_READ(_RESET_RESET_REASON_STATUS_EXTR_VREG(index)));
}


#endif /*_RESET_RESETREASONSTATUS_MZ_1_H*/
