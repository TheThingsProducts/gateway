...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_VREG(index)
    _RESET_RESET_BOTH_CONFIG_REG_READ_ERROR_VREG(index)
  ...
  POSs: 
    _RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_POS(index)
    _RESET_RESET_BOTH_CONFIG_REG_READ_ERROR_POS(index)

  LENs: 
    _RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_LEN(index)
    _RESET_RESET_BOTH_CONFIG_REG_READ_ERROR_LEN(index)
...
{
    return(RESET_CONFIG_REG_READ_ERROR)((_SFR_READ(_RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_VREG(index))) & (_RESET_RESET_PRIMARY_CONFIG_REG_READ_ERROR_MASK(index))& (_RESET_RESET_BOTH_CONFIG_REG_READ_ERROR_MASK(index)));
}
