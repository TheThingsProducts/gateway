...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _RESET_RESET_REASON_STATUS_HVDR_VREG(index)
  ...
  MASKs: 
    _RESET_RESET_REASON_STATUS_HVDR_MASK(index)
  ...
  POSs: 
    _RESET_RESET_REASON_STATUS_HVDR_POS(index)
  ...
  LENs: 
    _RESET_RESET_REASON_STATUS_HVDR_LEN(index)
