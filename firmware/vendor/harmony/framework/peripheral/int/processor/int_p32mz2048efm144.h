...
PLIB_INLINE SFR_TYPE* _INT_SOFTWARE_NMI_VREG(INT_MODULE_ID i)
{
    switch (i) {
        case INT_ID_0 :
            return &INTCON;
...
PLIB_INLINE SFR_DATA _INT_SOFTWARE_NMI_MASK(INT_MODULE_ID i)
{
    switch (i) {
        case INT_ID_0 :
            return _INTCON_NMIKEY_MASK;
        case INT_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _INT_SOFTWARE_NMI_POS(INT_MODULE_ID i)
{
    switch (i) {
        case INT_ID_0 :
            return _INTCON_NMIKEY_POSITION;
        case INT_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
...
PLIB_INLINE SFR_DATA _INT_SOFTWARE_NMI_LEN(INT_MODULE_ID i)
{
    switch (i) {
        case INT_ID_0 :
            return _INTCON_NMIKEY_LENGTH;
        case INT_NUMBER_OF_MODULES :
        default :
            return (SFR_DATA)-1;
    }
