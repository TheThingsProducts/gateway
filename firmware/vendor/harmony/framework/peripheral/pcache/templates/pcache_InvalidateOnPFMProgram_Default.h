...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _PCACHE_INVALIDATE_ON_PFM_PROGRAM_VREG(index)

  MASKs: 
    _PCACHE_INVALIDATE_ON_PFM_PROGRAM_MASK(index)

  POSs: 
    _PCACHE_INVALIDATE_ON_PFM_PROGRAM_POS(index)

  LENs: 
    _PCACHE_INVALIDATE_ON_PFM_PROGRAM_LEN(index)
...
{
    _SFR_BIT_SET(_PCACHE_INVALIDATE_ON_PFM_PROGRAM_VREG(index), _PCACHE_INVALIDATE_ON_PFM_PROGRAM_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_PCACHE_INVALIDATE_ON_PFM_PROGRAM_VREG(index), _PCACHE_INVALIDATE_ON_PFM_PROGRAM_POS(index));
}
