...
<#if CONFIG_USE_PORT_A == true && CONFIG_SYS_PORT_A_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "A"/> </#if>
<#if CONFIG_USE_PORT_B == true && CONFIG_SYS_PORT_B_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "B"/> </#if>
<#if CONFIG_USE_PORT_C == true && CONFIG_SYS_PORT_C_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "C"/> </#if>
<#if CONFIG_USE_PORT_D == true && CONFIG_SYS_PORT_D_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "D"/> </#if>
<#if CONFIG_USE_PORT_E == true && CONFIG_SYS_PORT_E_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "E"/> </#if>
<#if CONFIG_USE_PORT_F == true && CONFIG_SYS_PORT_F_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "F"/> </#if>
<#if CONFIG_USE_PORT_G == true && CONFIG_SYS_PORT_G_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "G"/> </#if>
<#if CONFIG_USE_PORT_H == true && CONFIG_SYS_PORT_H_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "H"/> </#if>
<#if CONFIG_USE_PORT_J == true && CONFIG_SYS_PORT_J_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "J"/> </#if>
<#if CONFIG_USE_PORT_K == true && CONFIG_SYS_PORT_K_CNEN != "0x0"> <@SYS_PORTS_MZ_CN_ASM_ISR PORT_NAME = "K"/> </#if>
<#else>
