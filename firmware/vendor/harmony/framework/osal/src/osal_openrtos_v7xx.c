/*******************************************************************************
  OPENRTOS OSAL compatibility layer
  ...
  Summary:
    Provide OSAL mappings for the OPENRTOS Real-time operating system

  Description:
    This file contains functional implementations of the OSAL for OPENRTOS.
